...
function commandRobot(id, targetX, targetY) {
    ...
    const currentTrajectories = getAllTrajectories(id);
    ...
    if (collidingTrajectories.length === 0) {
        ...
        console.log('collidingTrajectories:');
        console.log(collidingTrajectories);
        ...
        if (tangentX == NaN || tangentY == NaN) {
            setTimeout(commandRobot.bind(null, id, targetX, targetY), 2000);
        } else {
...
setTimeout(() => {
    commandRobot(13, 150, 30);
    commandRobot(10, 30, 150);
}, 2000);

setTimeout(() => {
    commandRobot(13, 30, 30);
    commandRobot(10, 150, 150);
}, 20000);
